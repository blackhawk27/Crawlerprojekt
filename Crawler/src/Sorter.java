...
public class Sorter {
    ...
    public static void main(String[] args) {
        ...
        // ArrayList<String> courseDetails = sorter.getAll("Matematik 1a (Polyteknisk
        // grundlag)");
    ...
    public String[][] getTable() {
        ...
        try {
            ...
            for (int i = 0; i < data.size(); i++) {
                ...
                Matrix[i + 1][2] = course.get("placement"); // schedule_placement
    ...
    // ArrayList<String> courseGrades = sorter.getGrades("Matematik 1a (Polyteknisk
    // grundlag)");
     ...
     * - En metode, der kan finde alle kurser, der har en bestemt underviser / give
     * en liste over alle undervisere til et
     * bestemt kursus
