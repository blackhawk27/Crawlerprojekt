    ...
    public String crawl() {
        ...
        try {
            ...
            Elements mainHTML = rawData.select("td a[href]"); // Returns an object of Elements type, from table. It is
                                                              // using the ancestor child formatting of input.
            // Vi tager hele linket, så vi har en liste der ser sådan her ud: [01001 -
            // Mathematics 1a (Polytechnical Foundation), 01002 - Mathematics 1b
            // (Polytechnical Foundation),...n]
            // Det er alle links
